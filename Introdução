 🐢✨ Tartaruga Cometa – Sistema Integrado Web

- Um sistema web completo para gerenciar dados com eficiência, combinando **Java Web** robusto, interface moderna e experiência intuitiva.

---

 💡 Descrição do Projeto

O **Tartaruga Cometa** é um projeto desenvolvido para otimizar o gerenciamento de dados e processos internos. Ele integra  **backend** de forma eficiente, permitindo cadastro de usuários, remetentes e destinatários, com validação de CPF e CNPJ, operações CRUD completas e interface responsiva.
...
* ✅ Integração backend em **Java + JSP + Tomcat**.
